...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','try.py',62),
  ('statement -> expression','statement',1,'p_statement_expr','try.py',66),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','try.py',70),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','try.py',71),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','try.py',72),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','try.py',73),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','try.py',80),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','try.py',84),
  ('expression -> NUMBER','expression',1,'p_expression_number','try.py',88),
  ('expression -> NAME','expression',1,'p_expression_name','try.py',92),
]
